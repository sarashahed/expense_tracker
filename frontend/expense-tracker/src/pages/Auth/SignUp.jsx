...
const SignUp = () => {
  ...
  return (
    <AuthLayout>
      <div className="lg:w-full md:full mt-10 flex flex-col justify-start items-start px-4">
        ...
        <form onSubmit={handleSignUp} className="w-full max-w-md flex flex-col gap-4">
          {/* Profile photo with some left margin */}
          <div className="ml-70 mb-6">
            <ProfilePhotoSelector image={profilePic} setImage={setProfilePic} />
          </div>

          {/* Individual input fields aligned left */}
          <Input
            value={fullName}
          ...
          <button type="submit" className="btn-primary self-start mt-4 px-6">
            Sign Up
          </button>
